...
def _legacy_dataset_specs() -> list[DatasetSpec]:
    ...
    return [
        ...
        _spec(
            ...
            ("_driver_ts_code", "ts_code"),
            default_fields=("ts_code", "con_code", "con_name", "weight", "in_date", "out_date", "is_new"),
            group="membership",
            min_profile="full",
        ...
        _spec(
            ...
            ("_driver_ts_code", "ts_code"),
            default_fields=("trade_date", "ts_code", "con_code", "name"),
            empty_policy="allow_empty",
            group="membership",
            min_profile="full",
        ...
        _spec(
            ...
            units={"amount": "元", "net_amount": "元", "buy": "元", "sell": "元"},
            default_fields=("trade_date", "ts_code", "name", "close", "change", "rank", "market_type", "amount", "net_amount", "buy", "sell"),
            analysis_columns=("amount",),
