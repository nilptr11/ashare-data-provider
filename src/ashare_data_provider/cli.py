...
def build_parser() -> argparse.ArgumentParser:
    ...
    check_parser.add_argument("--trade-days", type=int, default=30, help="检查最近多少个交易日，默认 30")
    ...
    report_parser.add_argument("--trade-days", type=int, default=30, help="检查最近多少个交易日，默认 30")
    ...
    bundle_parser.add_argument("--trade-days", type=int, default=120, help="读取最近多少个交易日，默认 120；策略窗口可按需调整")
